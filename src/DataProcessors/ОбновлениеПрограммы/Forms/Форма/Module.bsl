...
Функция ДоступноНесколькоВерсийДляОбновлений()
	...
	ИначеЕсли ЗначениеЗаполнено(ИнформацияОДоступномОбновлении.ОкончаниеПоддержкиТекущейВерсии)
		...
		ВариантАктуальнойВерсии = ВариантыОбновлений[ИдентификаторАктуальнойВерсии()];	// см. НовыйВариантОбновления
		Если ВариантАктуальнойВерсии.Конфигурация = Неопределено
			Или Не ВариантАктуальнойВерсии.Конфигурация.ДоступноОбновление Тогда
		...
		АктуальнаяВерсия = ОбщегоНазначенияКлиентСервер.ВерсияКонфигурацииБезНомераСборки(
			ВариантАктуальнойВерсии.Конфигурация.Версия);
